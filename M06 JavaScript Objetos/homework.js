...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var hasProp = objeto.hasOwnProperty(propiedad);
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   var postTotal= objetoUsuario.posts;

   ver sumPosts= 0 ;

   for (for let i=0; i < postTotal.length; i++){
      if(postTotal[i].hasOwnProperty("likes")){
